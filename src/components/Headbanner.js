    ...
    return (
        <div className='Banner'>
            <div
                ...
                <div className='bg-gradient-to-r from-black px-8 py-24 xxs:py-5 xs:py-10 sm:py-13 md:py-16'>
                <div className='xxs:max-w-max xs:max-w-lg sm:max-w-xl md:max-w-2xl lg:pb-10 xs:pb-5 sm:pb-7 md:pb-8 xl:pb-15'>
